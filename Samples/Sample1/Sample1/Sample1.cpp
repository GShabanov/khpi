...
BEGIN_MESSAGE_MAP(CSample1App, CWinApp)
	ON_COMMAND(ID_APP_ABOUT, &CSample1App::OnAppAbout)
END_MESSAGE_MAP()


// CSample1App construction

CSample1App::CSample1App() noexcept
{
	...
	SetAppID(_T("Sample1.AppID.NoVersion"));
