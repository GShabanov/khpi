...
// Sample5.cpp : Defines the class behaviors for the application.
//
...
BEGIN_MESSAGE_MAP(CSample5App, CWinApp)
	ON_COMMAND(ID_APP_ABOUT, &CSample5App::OnAppAbout)
END_MESSAGE_MAP()


// CSample4App construction

CSample5App::CSample5App() noexcept
{
...
BOOL
CSample5App::OnIdle(LONG lCount)
{
...
// CSample5App initialization

BOOL CSample5App::InitInstance()
{
...
void CSample5App::OnAppAbout()
{
	CAboutDlg aboutDlg;
	aboutDlg.DoModal();
}

// CSample5App message handlers
