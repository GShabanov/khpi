...
template<class type, etype_t etype, class returnType>
__forceinline idScriptVariable<type, etype, returnType>::idScriptVariable() {
    data = NULL;
}

template<class type, etype_t etype, class returnType>
__forceinline bool idScriptVariable<type, etype, returnType>::IsLinked( void ) const {
    return ( data != NULL );
}

template<class type, etype_t etype, class returnType>
__forceinline void idScriptVariable<type, etype, returnType>::Unlink( void ) {
    data = NULL;
}

template<class type, etype_t etype, class returnType>
__forceinline void idScriptVariable<type, etype, returnType>::LinkTo( idScriptObject &obj, const char *name ) {
...
template<class type, etype_t etype, class returnType>
__forceinline idScriptVariable<type, etype, returnType> &idScriptVariable<type, etype, returnType>::operator=( const returnType &value ) {
...
template<class type, etype_t etype, class returnType>
__forceinline idScriptVariable<type, etype, returnType>::operator returnType() const {
    // check if we attempt to access the object before it's been linked
    assert( data );
...
typedef idScriptVariable<AString, ev_string, const char *>    idScriptString;
...
================
*/
__forceinline statement_t &idProgram::GetStatement( int index ) {
...
================
*/
__forceinline function_t *idProgram::GetFunction( int index ) {
...
================
*/
__forceinline int idProgram::GetFunctionIndex( const function_t *func ) {
...
================
*/
__forceinline int idProgram::GetReturnedInteger( void ) {
...
================
*/
__forceinline void idProgram::ReturnFloat( float value ) {
...
================
*/
__forceinline void idProgram::ReturnInteger( int value ) {
...
================
*/
__forceinline void idProgram::ReturnVector( idVec3 const &vec ) {
...
================
*/
__forceinline void idProgram::ReturnString( const char *string ) {
    AString::Copynz( returnStringDef->value.stringPtr, string, MAX_STRING_LEN );
}
...
================
*/
__forceinline const char *idProgram::GetFilename( int num ) {
    return fileList[ num ];
}
...
*/
__forceinline int
idProgram::GetLineNumberForStatement( int index ) {
...
idProgram::GetFilenameForStatement( int index ) {
