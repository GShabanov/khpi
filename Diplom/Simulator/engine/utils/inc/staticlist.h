...
*/
template<class type,int size>
__forceinline idStaticList<type,size>::idStaticList() {
	num = 0;
}
...
*/
template<class type,int size>
__forceinline idStaticList<type,size>::idStaticList( const idStaticList<type,size> &other ) {
	*this = other;
}
...
*/
template<class type,int size>
__forceinline idStaticList<type,size>::~idStaticList( void ) {
}
...
*/
template<class type,int size>
__forceinline void idStaticList<type,size>::Clear( void ) {
	num	= 0;
}
...
*/
template<class type,int size>
__forceinline void idStaticList<type,size>::DeleteContents( bool clear ) {
	int i;
...
*/
template<class type,int size>
__forceinline int idStaticList<type,size>::Num( void ) const {
	return num;
}
...
*/
template<class type,int size>
__forceinline int idStaticList<type,size>::Max( void ) const {
	return size;
}
...
*/
template<class type,int size>
__forceinline size_t idStaticList<type,size>::Allocated( void ) const {
...
*/
template<class type,int size>
__forceinline size_t idStaticList<type,size>::Size( void ) const {
...
*/
template<class type,int size>
__forceinline size_t idStaticList<type,size>::MemoryUsed( void ) const {
...
*/
template<class type,int size>
__forceinline void idStaticList<type,size>::SetNum( int newnum ) {
	assert( newnum >= 0 );
	assert( newnum <= size );
	num = newnum;
}
...
*/
template<class type,int size>
__forceinline const type &idStaticList<type,size>::operator[]( int index ) const {
	assert( index >= 0 );
	assert( index < num );
...
*/
template<class type,int size>
__forceinline type &idStaticList<type,size>::operator[]( int index ) {
	assert( index >= 0 );
	assert( index < num );
...
*/
template<class type,int size>
__forceinline type *idStaticList<type,size>::Ptr( void ) {
	return &list[ 0 ];
}
...
*/
template<class type,int size>
__forceinline const type *idStaticList<type,size>::Ptr( void ) const {
	return &list[ 0 ];
}
...
*/
template<class type,int size>
__forceinline type *idStaticList<type,size>::Alloc( void ) {
	if ( num >= size ) {
		return NULL;
	}
...
*/
template<class type,int size>
__forceinline int idStaticList<type,size>::Append( type const & obj ) {
	assert( num < size );
	if ( num < size ) {
		list[ num ] = obj;
		num++;
...
*/
template<class type,int size>
__forceinline int idStaticList<type,size>::Insert( type const & obj, int index ) {
	int i;
...
*/
template<class type,int size>
__forceinline int idStaticList<type,size>::Append( const idStaticList<type,size> &other ) {
	int i;
	int n = other.Num();
...
*/
template<class type,int size>
__forceinline int idStaticList<type,size>::AddUnique( type const & obj ) {
	int index;
...
*/
template<class type,int size>
__forceinline int idStaticList<type,size>::FindIndex( type const & obj ) const {
	int i;
...
*/
template<class type,int size>
__forceinline type *idStaticList<type,size>::Find( type const & obj ) const {
	int i;
...
*/
template<class type,int size>
__forceinline int idStaticList<type,size>::FindNull( void ) const {
	int i;
...
*/
template<class type,int size>
__forceinline int idStaticList<type,size>::IndexOf( type const *objptr ) const {
	int index;
...
*/
template<class type,int size>
__forceinline bool idStaticList<type,size>::RemoveIndex( int index ) {
	int i;
...
*/
template<class type,int size>
__forceinline bool idStaticList<type,size>::Remove( type const & obj ) {
	int index;
...
*/
template<class type,int size>
__forceinline void idStaticList<type,size>::Swap( idStaticList<type,size> &other ) {
