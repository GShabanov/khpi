...
{
    UNREFERENCED_PARAMETER(cinfo);
    UNREFERENCED_PARAMETER(sizeofobject);
    free(object);
}
...
{
    UNREFERENCED_PARAMETER(cinfo);
    UNREFERENCED_PARAMETER(min_bytes_needed);
    UNREFERENCED_PARAMETER(already_allocated);
    ...
    long total_bytes_needed)
{
    ...
    UNREFERENCED_PARAMETER(total_bytes_needed);
