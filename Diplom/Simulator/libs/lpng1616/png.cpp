...
png_set_sig_bytes(png_structrp png_ptr, int num_bytes)
{
   ...
   if (num_bytes > 8)
      return png_error(png_ptr, "Too many bytes for PNG signature");
   ...
   int freer, png_uint_32 mask)
{
   ...
   if (freer == PNG_DESTROY_WILL_FREE_DATA)
      ...
      return png_error(png_ptr, "Unknown freer parameter in png_data_freer");
   ...
   png_colorspacerp colorspace, const png_xy *xy, int preferred)
{
   ...
   switch (png_colorspace_check_xy(&XYZ, xy))
   {
      ...
      default:
          ...
          */
         colorspace->flags |= PNG_COLORSPACE_INVALID;
         return png_error(png_ptr, "internal error checking chromaticities");
         break;
   }
...
png_colorspace_set_rgb_coefficients(png_structrp png_ptr)
{
      ...
      (png_ptr->colorspace.flags & PNG_COLORSPACE_HAVE_ENDPOINTS) != 0)
   {
       ...
       */
         ...
         return png_error(png_ptr, "internal error handling cHRM->XYZ");
   }
...
#  endif
   ...
   if (error == 1)
      return png_error(png_ptr, "Invalid IHDR data");
    ...
    double fp, unsigned int precision)
{
   ...
   return png_error(png_ptr, "ASCII conversion buffer too small");
}
...
#     else
         return png_error(c.png_ptr, "simplified write not supported");
#     endif
   }
   else
   {
...
#     else
         return png_error(c.png_ptr, "simplified read not supported");
#     endif
   }
